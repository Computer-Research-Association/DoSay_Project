"""V8b 환경 — 퍼텐셜 셰이핑을 강하게 (POTENTIAL_SCALE=1.0).
...
V8a 와 V8b 는 SCALE 만 다르다. V8b = 1.0 — 대역 V 실험(117.9점)에서 쓴 것과
같은 강도다. Φ 가 서열을 주도하고 V 는 보정만 한다. 바닥이 가장 높은 대신,
V 가 실제로 형제를 구분할 수 있다면 그 능력을 덜 살리는 쪽이다.
"""
