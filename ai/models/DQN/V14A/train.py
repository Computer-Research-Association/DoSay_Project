"""DQN V14A — **학습용이 아니다.** V14 체크포인트를 다른 배포 모드로 재기 위한 폴더.

    cp ai/models/DQN/V14/models/V14_DQN_<스텝>.zip \n       ai/models/DQN/V14A/models/V14A_DQN_<스텝>.zip
    python runs/measure.py --checkpoint ai/models/DQN/V14A/models/V14A_DQN_<스텝>.zip

model.py 의 MODE 만 "afterstate" 로 다르다 (깊이 1 (합법수를 지운 판을 평가). 0.009초/수).
"""
